...
export default function HowItWorks(){return <main className="info-page">
  ...
  <header className="site-header"><a className="logo" href="/"><Mark/><span>TrialLens</span><sup>AI</sup></a><nav><a className="active" href="/how-it-works">How it works</a><a href="/#sources">Sources</a><a href="/responsible-ai">Responsible AI</a></nav><a className="header-action" href="/new-review">New review <span>→</span></a></header>
  <section className="info-hero"><span className="mini-label">HOW IT WORKS</span><h1>From a development question<br/>to a <em>source-traceable review.</em></h1><p>TrialLens is an evidence-retrieval and review workspace. It helps teams establish what evidence exists, where it came from and what still needs expert interpretation.</p><a className="info-cta" href="/new-review">Start a new review <span>→</span></a></section>
  ...
  <footer><a className="logo" href="/"><Mark/><span>TrialLens</span><sup>AI</sup></a><p>Evidence → context → human decision</p><span>Decision-support only</span></footer>
  </main>}
